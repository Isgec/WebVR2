<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_vrUnLinkedRequest.aspx.vb" Inherits="EF_vrUnLinkedRequest" title="Edit: Un-Linked Request" %>
<asp:Content ID="CPHvrUnLinkedRequest" ContentPlaceHolderID="cph1" Runat="Server">
  <div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltaBDLodging" runat="server" Text="&nbsp;Display: Un-Linked Request"></asp:Label>
</div>
...
<ContentTemplate>
  <LGM:ToolBar0 
    ...
    EnableDelete = "False"
    EnableSave="false"
    ValidationGroup = "vrUnLinkedRequest"
    runat = "server" />
<asp:FormView ID="FVvrUnLinkedRequest"
	runat = "server"
	DataKeyNames = "RequestNo"
	DataSourceID = "ODSvrUnLinkedRequest"
    ...
    <div id="frmdiv" class="ui-widget-content minipage">
        ...
        <td colspan="2">
          <script type="text/javascript">
      				...
      				pcnt = pcnt + 1;
      				var nam = 'wdwd' + pcnt;
      				var url = self.location.href.replace('App_Edit/EF_vrUnLinkedRequest.aspx', 'App_Downloads/filedownload.aspx');
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "vrUnLinkedRequestGetByID"
  UpdateMethod="vrUnLinkedRequestUpdate"
  OldValuesParameterFormatString = "original_{0}"
