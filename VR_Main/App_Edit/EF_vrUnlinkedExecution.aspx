<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_vrUnlinkedExecution.aspx.vb" Inherits="EF_vrUnlinkedExecution" title="Edit: Unlinked Execution" %>
<asp:Content ID="CPHvrUnlinkedExecution" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="page">
<asp:UpdatePanel ID="UPNLvrUnlinkedExecution" runat="server" >
<ContentTemplate>
  <asp:Label ID="LabelvrUnlinkedExecution" runat="server" Text="&nbsp;Edit: Unlinked Execution" Width="100%" CssClass="sis_formheading"></asp:Label>
  <LGM:ToolBar0 
    ...
    Skin = "tbl_blue"
    runat = "server" />
<asp:FormView ID="FVvrUnlinkedExecution"
	runat = "server"
	DataKeyNames = "SRNNo"
	DataSourceID = "ODSvrUnlinkedExecution"
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "UZ_vrUnlinkedExecutionGetByID"
  UpdateMethod="UZ_vrUnlinkedExecutionUpdate"
  OldValuesParameterFormatString = "original_{0}"
