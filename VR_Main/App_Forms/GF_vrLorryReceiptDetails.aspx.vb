Partial Class GF_vrLorryReceiptDetails
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/VR_Main/App_Display/DF_vrLorryReceiptDetails.aspx"
  ...
  Protected Sub GVvrLorryReceiptDetails_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVvrLorryReceiptDetails.Init
    DataClassName = "GvrLorryReceiptDetails"
    SetGridView = GVvrLorryReceiptDetails
  End Sub
