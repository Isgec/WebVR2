<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_vrSanctionExecutionApproval.aspx.vb" Inherits="GF_vrSanctionExecutionApproval" title="List: Sanction Approval" %>
...
<asp:UpdatePanel ID="UPNLvrExecutionApproval" runat="server">
  <ContentTemplate>
    <asp:Label ID="LabelvrExecutionApproval" runat="server" Text="&nbsp;List: Sanction Approval" Width="100%" CssClass="sis_formheading"></asp:Label>
   ...
   var script_ApprovalRemarks = {
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "UZ_vrSanctionExecutionApprovalSelectList"
