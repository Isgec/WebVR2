Partial Class RP_vrGroups
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    Dim aVal() As String = Request.QueryString("pk").Split("|".ToCharArray)
		Dim GroupID As Int32 = CType(aVal(0),Int32)
		Dim oVar As SIS.VR.vrGroups = SIS.VR.vrGroups.vrGroupsGetByID(GroupID)
    ...
    oRow.Cells.Add(oCol)
    oCol = New TableCell
    oCol.Text = "Group Name"
    oRow.Cells.Add(oCol)
    oCol = New TableCell
    oCol.Text = oVar.GroupName
    oRow.Cells.Add(oCol)
    oCol = New TableCell
    oCol.Text = ""
    oRow.Cells.Add(oCol)
