Partial Class RP_vrPendingVehicleRequest
  Inherits System.Web.UI.Page
  Private _InfoUrl As String = "~/VR_Main/App_Display/DF_vrPendingVehicleRequest.aspx"
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    Dim aVal() As String = Request.QueryString("pk").Split("|".ToCharArray)
		...
		Dim oVar As SIS.VR.vrPendingVehicleRequest = SIS.VR.vrPendingVehicleRequest.vrPendingVehicleRequestGetByID(RequestNo)
