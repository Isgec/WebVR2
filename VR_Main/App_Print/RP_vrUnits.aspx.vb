Partial Class RP_vrUnits
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    Dim aVal() As String = Request.QueryString("pk").Split("|".ToCharArray)
		Dim UnitID As Int32 = CType(aVal(0),Int32)
		Dim oVar As SIS.VR.vrUnits = SIS.VR.vrUnits.vrUnitsGetByID(UnitID)
    ...
    oRow = New TableRow
    oCol = New TableCell
    oCol.Text = "Conversion Factor [Base Unit KG or FT]"
    oRow.Cells.Add(oCol)
    oCol = New TableCell
    oCol.Text = oVar.ConversionFactor
    oRow.Cells.Add(oCol)
    oCol = New TableCell
    oCol.Text = ""
    oRow.Cells.Add(oCol)
