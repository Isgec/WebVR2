...
Namespace SIS.VR
  ...
  Partial Public Class vrReports
    ...
    Private _FK_VR_Reports_FSupplier As SIS.VR.vrTransporters = Nothing
    Private _FK_VR_Reports_TSupplier As SIS.VR.vrTransporters = Nothing
    ...
    Public ReadOnly Property FK_VR_Reports_TProjectID() As SIS.QCM.qcmProjects
      ...
      End Get
    End Property
    Public ReadOnly Property FK_VR_Reports_FSupplier() As SIS.VR.vrTransporters
      Get
        If _FK_VR_Reports_FSupplier Is Nothing Then
          _FK_VR_Reports_FSupplier = SIS.VR.vrTransporters.vrTransportersGetByID(_FSupplier)
        End If
        Return _FK_VR_Reports_FSupplier
      End Get
    End Property
    Public ReadOnly Property FK_VR_Reports_TSupplier() As SIS.VR.vrTransporters
      Get
        If _FK_VR_Reports_TSupplier Is Nothing Then
          _FK_VR_Reports_TSupplier = SIS.VR.vrTransporters.vrTransportersGetByID(_TSupplier)
        End If
        Return _FK_VR_Reports_TSupplier
      End Get
    End Property
