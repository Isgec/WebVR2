...
Namespace SIS.CT
  ...
  Partial Public Class ctDetail
    ...
    Public Shared Function ctDetailGetNewRecord() As SIS.CT.ctDetail
      Return New SIS.CT.ctDetail()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function ctDetailGetByID(ByVal t_trdt As DateTime, ByVal t_bohd As String, ByVal t_indv As String, ByVal t_srno As Int32, ByVal t_dsno As Int32) As SIS.CT.ctDetail
      Dim Results As SIS.CT.ctDetail = Nothing
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "spctDetailSelectByID"
					...
					If Reader.Read() Then
						Results = New SIS.CT.ctDetail(Reader)
					End If
					Reader.Close()
				End Using
			End Using
		...
		End Function
		<DataObjectMethod(DataObjectMethodType.Select)> _
		Public Shared Function ctDetailSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String) As List(Of SIS.CT.ctDetail)
			Dim Results As List(Of SIS.CT.ctDetail) = Nothing
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					If SearchState Then
						Cmd.CommandText = "spctDetailSelectListSearch"
						SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
					Else
						Cmd.CommandText = "spctDetailSelectListFilteres"
					End If
					...
					_RecordCount = -1
					Results = New List(Of SIS.CT.ctDetail)()
					Con.Open()
					Dim Reader As SqlDataReader = Cmd.ExecuteReader()
					While (Reader.Read())
						Results.Add(New SIS.CT.ctDetail(Reader))
					End While
					Reader.Close()
			...
			Return Results
		End Function
		Public Shared Function ctDetailSelectCount(ByVal SearchState As Boolean, ByVal SearchText As String) As Integer
			Return _RecordCount
		End Function
		'Select By ID One Record Filtered Overloaded GetByID
		<DataObjectMethod(DataObjectMethodType.Insert, True)> _
		Public Shared Function ctDetailInsert(ByVal Record As SIS.CT.ctDetail) As SIS.CT.ctDetail
			Dim _Rec As SIS.CT.ctDetail = SIS.CT.ctDetail.ctDetailGetNewRecord()
			With _Rec
			...
			End With
			Return SIS.CT.ctDetail.InsertData(_Rec)
		End Function
		Public Shared Function InsertData(ByVal Record As SIS.CT.ctDetail) As SIS.CT.ctDetail
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "spctDetailInsert"
		...
		Public Shared Function ctDetailUpdate(ByVal Record As SIS.CT.ctDetail) As SIS.CT.ctDetail
			Dim _Rec As SIS.CT.ctDetail = SIS.CT.ctDetail.ctDetailGetByID(Record.t_trdt, Record.t_bohd, Record.t_indv, Record.t_srno, Record.t_dsno)
			With _Rec
				.t_stat = Record.t_stat
				.t_proj = Record.t_proj
				.t_elem = Record.t_elem
				...
				.t_Refcntu = Record.t_Refcntu
			End With
			Return SIS.CT.ctDetail.UpdateData(_Rec)
		End Function
		Public Shared Function UpdateData(ByVal Record As SIS.CT.ctDetail) As SIS.CT.ctDetail
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "spctDetailUpdate"
		...
		Public Shared Function ctDetailDelete(ByVal Record As SIS.CT.ctDetail) As Int32
			Dim _Result As Integer = 0
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "spctDetailDelete"
