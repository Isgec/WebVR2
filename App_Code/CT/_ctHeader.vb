...
Namespace SIS.CT
  ...
  Partial Public Class ctHeader
    ...
    Public Shared Function ctHeaderGetNewRecord() As SIS.CT.ctHeader
      Return New SIS.CT.ctHeader()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function ctHeaderGetByID(ByVal t_trdt As DateTime, ByVal t_bohd As String, ByVal t_indv As String, ByVal t_srno As Int32) As SIS.CT.ctHeader
      Dim Results As SIS.CT.ctHeader = Nothing
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "spctHeaderSelectByID"
					...
					If Reader.Read() Then
						Results = New SIS.CT.ctHeader(Reader)
					End If
					Reader.Close()
				End Using
			End Using
		...
		End Function
		<DataObjectMethod(DataObjectMethodType.Select)> _
		Public Shared Function ctHeaderSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String) As List(Of SIS.CT.ctHeader)
			Dim Results As List(Of SIS.CT.ctHeader) = Nothing
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					If SearchState Then
						Cmd.CommandText = "spctHeaderSelectListSearch"
						SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
					Else
						Cmd.CommandText = "spctHeaderSelectListFilteres"
					End If
					...
					_RecordCount = -1
					Results = New List(Of SIS.CT.ctHeader)()
					Con.Open()
					Dim Reader As SqlDataReader = Cmd.ExecuteReader()
					While (Reader.Read())
						Results.Add(New SIS.CT.ctHeader(Reader))
					End While
					Reader.Close()
			...
			Return Results
		End Function
		Public Shared Function ctHeaderSelectCount(ByVal SearchState As Boolean, ByVal SearchText As String) As Integer
			Return _RecordCount
		End Function
		'Select By ID One Record Filtered Overloaded GetByID
		<DataObjectMethod(DataObjectMethodType.Insert, True)> _
		Public Shared Function ctHeaderInsert(ByVal Record As SIS.CT.ctHeader) As SIS.CT.ctHeader
			Dim _Rec As SIS.CT.ctHeader = SIS.CT.ctHeader.ctHeaderGetNewRecord()
			With _Rec
			...
			End With
			Return SIS.CT.ctHeader.InsertData(_Rec)
		End Function
		Public Shared Function InsertData(ByVal Record As SIS.CT.ctHeader) As SIS.CT.ctHeader
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "spctHeaderInsert"
		...
		Public Shared Function ctHeaderUpdate(ByVal Record As SIS.CT.ctHeader) As SIS.CT.ctHeader
			Dim _Rec As SIS.CT.ctHeader = SIS.CT.ctHeader.ctHeaderGetByID(Record.t_trdt, Record.t_bohd, Record.t_indv, Record.t_srno)
			With _Rec
				.t_stat = Record.t_stat
				.t_proj = Record.t_proj
				.t_elem = Record.t_elem
				...
				.t_Refcntu = Record.t_Refcntu
			End With
			Return SIS.CT.ctHeader.UpdateData(_Rec)
		End Function
		Public Shared Function UpdateData(ByVal Record As SIS.CT.ctHeader) As SIS.CT.ctHeader
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "spctHeaderUpdate"
		...
		Public Shared Function ctHeaderDelete(ByVal Record As SIS.CT.ctHeader) As Int32
			Dim _Result As Integer = 0
			Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
				Using Cmd As SqlCommand = Con.CreateCommand()
					Cmd.CommandType = CommandType.StoredProcedure
					Cmd.CommandText = "spctHeaderDelete"
